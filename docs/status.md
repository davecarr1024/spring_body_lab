...
| Browser | Step, Play, Nudge amber/blue, weak-wall load/Ram, rope load/Swing, sheet load/Lift, block load/Launch, and Reset controls rendering state, goals, springs, contacts, normals, breaks, and components | nine Playwright Chromium smoke tests against the built artifact, including end-to-end weak-wall, rope, sheet, and block-ram goals plus stable Play/Pause controls |
