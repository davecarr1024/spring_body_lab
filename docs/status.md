...
| Browser | lab inspector plus standalone live Mossyard and Trail Driver routes | thirteen Playwright Chromium tests cover the built artifact, including Trail Driver keyboard input, camera-following parallax, terrain/body material markup, no debug circles, and finite rendered vehicle geometry |
