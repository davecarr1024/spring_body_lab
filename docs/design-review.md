...
| Tests as deliverable | Public behavior is tested by library layer. | 100% current production line/function coverage; boundary/degenerate cases included. | Raise branch coverage through command/replay validation and add browser smoke tests. |
