...
function render() {
  ...
  document.querySelector("#app").innerHTML = `
    <main class="lab-shell">
      ...
      </section><footer><span>${state.scenario === "gravity" ? "Constant acceleration · analytic reference available" : "Undamped harmonic oscillator · analytic reference available"}</span><span>Headless model • deterministic trace • browser inspector</span></footer></main>`;
